...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(38726931852627901885)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726932192770901885)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726932472080901885)
,p_page_template_id=>wwv_flow_imp.id(38726931852627901885)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726932799316901885)
,p_page_template_id=>wwv_flow_imp.id(38726931852627901885)
