...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(38726923299834901880)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726923511925901880)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726923816361901880)
,p_page_template_id=>wwv_flow_imp.id(38726923299834901880)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726924127775901880)
,p_page_template_id=>wwv_flow_imp.id(38726923299834901880)
