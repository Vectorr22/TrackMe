...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(38726913236100901875)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726913564549901875)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726913852571901875)
,p_page_template_id=>wwv_flow_imp.id(38726913236100901875)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726914111078901876)
,p_page_template_id=>wwv_flow_imp.id(38726913236100901875)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726914470663901876)
,p_page_template_id=>wwv_flow_imp.id(38726913236100901875)
,p_name=>'Body Footer'
