...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(38726902630387901869)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726902985918901870)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726903235202901870)
,p_page_template_id=>wwv_flow_imp.id(38726902630387901869)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726903526154901870)
,p_page_template_id=>wwv_flow_imp.id(38726902630387901869)
