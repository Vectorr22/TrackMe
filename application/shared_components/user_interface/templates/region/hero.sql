...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38726971886093901903)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726972199932901903)
,p_plug_template_id=>wwv_flow_imp.id(38726971886093901903)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726972476282901903)
,p_plug_template_id=>wwv_flow_imp.id(38726971886093901903)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726972752677901903)
,p_plug_template_id=>wwv_flow_imp.id(38726971886093901903)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726973017486901903)
,p_plug_template_id=>wwv_flow_imp.id(38726971886093901903)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726973332497901904)
,p_plug_template_id=>wwv_flow_imp.id(38726971886093901903)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
