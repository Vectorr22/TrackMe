...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38726997430656901914)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726997710317901914)
,p_plug_template_id=>wwv_flow_imp.id(38726997430656901914)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726998000331901914)
,p_plug_template_id=>wwv_flow_imp.id(38726997430656901914)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726998362476901915)
,p_plug_template_id=>wwv_flow_imp.id(38726997430656901914)
,p_name=>'Button Start'
