...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38727014959551901922)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38727015230429901923)
,p_plug_template_id=>wwv_flow_imp.id(38727014959551901922)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38727015523911901923)
,p_plug_template_id=>wwv_flow_imp.id(38727014959551901922)
,p_name=>'Tabs'
