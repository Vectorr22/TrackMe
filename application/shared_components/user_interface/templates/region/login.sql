...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38726999938860901915)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38727000222580901916)
,p_plug_template_id=>wwv_flow_imp.id(38726999938860901915)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38727000523558901916)
,p_plug_template_id=>wwv_flow_imp.id(38726999938860901915)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38727000800658901916)
,p_plug_template_id=>wwv_flow_imp.id(38726999938860901915)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38727001156707901916)
,p_plug_template_id=>wwv_flow_imp.id(38726999938860901915)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38727001400231901916)
,p_plug_template_id=>wwv_flow_imp.id(38726999938860901915)
,p_name=>'Sub Regions'
