...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38726967239965901901)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726967547616901901)
,p_plug_template_id=>wwv_flow_imp.id(38726967239965901901)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726967844946901901)
,p_plug_template_id=>wwv_flow_imp.id(38726967239965901901)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726968101020901901)
,p_plug_template_id=>wwv_flow_imp.id(38726967239965901901)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726968492151901901)
,p_plug_template_id=>wwv_flow_imp.id(38726967239965901901)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726968755513901901)
,p_plug_template_id=>wwv_flow_imp.id(38726967239965901901)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726969036540901901)
,p_plug_template_id=>wwv_flow_imp.id(38726967239965901901)
,p_name=>'Sub Regions'
