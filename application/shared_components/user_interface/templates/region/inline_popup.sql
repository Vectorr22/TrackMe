...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38726989991904901911)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726990201330901911)
,p_plug_template_id=>wwv_flow_imp.id(38726989991904901911)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726990508011901911)
,p_plug_template_id=>wwv_flow_imp.id(38726989991904901911)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726990827737901911)
,p_plug_template_id=>wwv_flow_imp.id(38726989991904901911)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726991131523901911)
,p_plug_template_id=>wwv_flow_imp.id(38726989991904901911)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726991442878901912)
,p_plug_template_id=>wwv_flow_imp.id(38726989991904901911)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726991734726901912)
,p_plug_template_id=>wwv_flow_imp.id(38726989991904901911)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726992098138901912)
,p_plug_template_id=>wwv_flow_imp.id(38726989991904901911)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726992301523901912)
,p_plug_template_id=>wwv_flow_imp.id(38726989991904901911)
,p_name=>'Sub Regions'
