...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38726939906486901889)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726940291244901889)
,p_plug_template_id=>wwv_flow_imp.id(38726939906486901889)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726940532225901890)
,p_plug_template_id=>wwv_flow_imp.id(38726939906486901889)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726940867102901890)
,p_plug_template_id=>wwv_flow_imp.id(38726939906486901889)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726941166696901890)
,p_plug_template_id=>wwv_flow_imp.id(38726939906486901889)
,p_name=>'Sub Regions'
