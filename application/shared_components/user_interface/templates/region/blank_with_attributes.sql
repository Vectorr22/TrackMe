...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38726938517854901888)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726938868308901889)
,p_plug_template_id=>wwv_flow_imp.id(38726938517854901888)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726939138154901889)
,p_plug_template_id=>wwv_flow_imp.id(38726938517854901888)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726939405579901889)
,p_plug_template_id=>wwv_flow_imp.id(38726938517854901888)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726939701947901889)
,p_plug_template_id=>wwv_flow_imp.id(38726938517854901888)
,p_name=>'Sub Regions'
