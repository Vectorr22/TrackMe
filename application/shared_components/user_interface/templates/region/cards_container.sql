...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38726945626329901892)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726945975891901892)
,p_plug_template_id=>wwv_flow_imp.id(38726945626329901892)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726946249611901892)
,p_plug_template_id=>wwv_flow_imp.id(38726945626329901892)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726946510067901892)
,p_plug_template_id=>wwv_flow_imp.id(38726945626329901892)
,p_name=>'Sub Regions'
