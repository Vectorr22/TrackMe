...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38727022695041901926)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38727022942947901926)
,p_plug_template_id=>wwv_flow_imp.id(38727022695041901926)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38727023263657901926)
,p_plug_template_id=>wwv_flow_imp.id(38727022695041901926)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38727023502571901926)
,p_plug_template_id=>wwv_flow_imp.id(38727022695041901926)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38727023842342901926)
,p_plug_template_id=>wwv_flow_imp.id(38727022695041901926)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38727024137316901926)
,p_plug_template_id=>wwv_flow_imp.id(38727022695041901926)
