...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38726985318003901909)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726985629180901909)
,p_plug_template_id=>wwv_flow_imp.id(38726985318003901909)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726985907573901909)
,p_plug_template_id=>wwv_flow_imp.id(38726985318003901909)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726986255982901909)
,p_plug_template_id=>wwv_flow_imp.id(38726985318003901909)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726986525478901909)
,p_plug_template_id=>wwv_flow_imp.id(38726985318003901909)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726986821246901909)
,p_plug_template_id=>wwv_flow_imp.id(38726985318003901909)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726987167601901909)
,p_plug_template_id=>wwv_flow_imp.id(38726985318003901909)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726987467097901910)
,p_plug_template_id=>wwv_flow_imp.id(38726985318003901909)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726987753087901910)
,p_plug_template_id=>wwv_flow_imp.id(38726985318003901909)
,p_name=>'Sub Regions'
