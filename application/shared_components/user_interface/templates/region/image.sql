...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38726975336079901904)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726975616028901905)
,p_plug_template_id=>wwv_flow_imp.id(38726975336079901904)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726975947655901905)
,p_plug_template_id=>wwv_flow_imp.id(38726975336079901904)
,p_name=>'Sub Regions'
