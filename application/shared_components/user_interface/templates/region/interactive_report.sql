...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38726995399765901913)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726995691337901913)
,p_plug_template_id=>wwv_flow_imp.id(38726995399765901913)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726995974679901914)
,p_plug_template_id=>wwv_flow_imp.id(38726995399765901913)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726996299886901914)
,p_plug_template_id=>wwv_flow_imp.id(38726995399765901913)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726996596323901914)
,p_plug_template_id=>wwv_flow_imp.id(38726995399765901913)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726996889858901914)
,p_plug_template_id=>wwv_flow_imp.id(38726995399765901913)
,p_name=>'Sub Regions'
