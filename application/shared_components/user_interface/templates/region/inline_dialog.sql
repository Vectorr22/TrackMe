...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38726980723235901907)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726981041182901907)
,p_plug_template_id=>wwv_flow_imp.id(38726980723235901907)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726981379348901907)
,p_plug_template_id=>wwv_flow_imp.id(38726980723235901907)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726981609846901907)
,p_plug_template_id=>wwv_flow_imp.id(38726980723235901907)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726981953717901907)
,p_plug_template_id=>wwv_flow_imp.id(38726980723235901907)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726982257927901907)
,p_plug_template_id=>wwv_flow_imp.id(38726980723235901907)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726982529936901907)
,p_plug_template_id=>wwv_flow_imp.id(38726980723235901907)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726982806606901908)
,p_plug_template_id=>wwv_flow_imp.id(38726980723235901907)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38726983120393901908)
,p_plug_template_id=>wwv_flow_imp.id(38726980723235901907)
,p_name=>'Sub Regions'
