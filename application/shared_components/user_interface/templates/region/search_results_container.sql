...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38727002455802901917)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38727002732883901917)
,p_plug_template_id=>wwv_flow_imp.id(38727002455802901917)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38727003042599901917)
,p_plug_template_id=>wwv_flow_imp.id(38727002455802901917)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38727003304225901917)
,p_plug_template_id=>wwv_flow_imp.id(38727002455802901917)
,p_name=>'Sub Regions'
